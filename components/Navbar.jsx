    ...
    <>
        ...
        <div className="hidden lg:flex items-center gap-8">
          <div className="flex items-center gap-6 text-[1.3rem] font-normal text-white">
            ...
            >
              ...
              <div
                className={`absolute top-full left-0 mt-4 w-70 transition-all duration-300 ease-out origin-top ${isOpen ? "opacity-100 translate-y-0 visible" : "opacity-0 -translate-y-2 invisible"}`}
              >
                <div className="bg-[#EEF6FF] rounded-sm p-4 shadow-xl">
                  {companies.map((item) => (
                    ...
                    >
                      <span className="text-[#0F172A] text-[1.2rem] font-medium font-author">
                        {item.name}
                      </span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        strokeWidth={2}
                        stroke="#0F172A"
                        className="w-5 h-5 transform group-hover/item:translate-x-1 transition-transform"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
        ...
        <Link href="/contact" className="relative group hidden lg:inline-block">
          ...
          <div className="relative p-[1.2px] rounded-xl overflow-hidden bg-gradient-to-br from-white via-zinc-800 to-blue-500">
            <div className="relative px-8 py-2.5 bg-[#050505] rounded-[11px] flex items-center justify-center overflow-hidden">
              ...
              <span className="relative z-10 text-[1.2rem] text-[#1EA1F7] font-normal">
                Get In Touch
              </span>
      ...
      >
        ...
        <Link
          ...
          className="text-2xl font-author font-medium hover:text-[#1EA1F7] transition-colors"
        >
          Home
        </Link>
        <Link
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div
            className={`flex flex-col items-center gap-4 overflow-hidden transition-all duration-500 ease-in-out ${isMobileDropdownOpen ? "max-h-[500px] mt-6 opacity-100" : "max-h-0 opacity-0"}`}
          >
