...
export default function App() {
 ...
 text-[#ECF5FF]  max-w-3xl"
          ...
          <p className="mt-14 text-xl md:text-[1.65rem] text-white max-w-xl leading-[1.1] tracking-wide font-normal">
          ...
          <Link
            href="#"
            className="mt-6 text-[#1FA5FD] text-[1.2rem] md:text-[1.65rem] font-normal inline-flex items-center gap-1    transition-colors group"
          >
            Discover more
